...
from emon_tools.fastapi.models.db import EmonHost
from emon_tools.fastapi.models.db import EmonHostCreate
from emon_tools.fastapi.models.db import EmonHostUpdate
from emon_tools.fastapi.models.db import EmonHostsPublic
...
@router.get("/", response_model=EmonHostsPublic)
async def read_root(
    session: SessionDep,
