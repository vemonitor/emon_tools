...
import numpy as np
import pytest
from emon_tools.emon_fina import FinaReader, MetaData
...
class TestFinaReader:
    ...
    @patch("emon_tools.emon_fina.isfile", return_value=False)
    ...
    @patch("emon_tools.emon_fina.isfile", return_value=True)
    @patch("emon_tools.emon_fina.getsize", return_value=400)
    ...
    @patch("emon_tools.emon_fina.isfile", return_value=True)
    @patch("emon_tools.emon_fina.mmap.mmap", autospec=True)
